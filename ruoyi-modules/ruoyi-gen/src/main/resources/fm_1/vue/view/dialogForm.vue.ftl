                ...
                <#if (column.insert || column.edit) && !column.pk>
                    <el-form-item label="${column.columnLabel}" prop="${column.javaField}">
                        ...
                        <#elseif column.htmlType == "select"><#--下拉框 select 字典-->
                            ...
                            <#elseif column.enumType?has_content>
                                <enum-select v-model="form.${column.javaField}" model="${v.base.moduleName}" enum-type="${column.enumType?substring(column.enumType?last_index_of(":") + 1)}" placeholder="请选择${column.columnLabel}" clearable/>
                            <#else>
                        ...
                        <#elseif column.htmlType == "radio"><#--单选框 radio 字典-->
                            ...
                            <#elseif column.enumType?has_content>
                                <enum-radio v-model="form.${column.javaField}" model="${v.base.moduleName}" enum-type="${column.enumType?substring(column.enumType?last_index_of(":") + 1)}" placeholder="请选择${column.columnLabel}" clearable/>
                            <#else>
                        ...
                        <#elseif column.htmlType == "checkbox"><#--复选框 checkbox 字典-->
                            ...
                            <#elseif column.enumType?has_content>
                                <enum-checkbox v-model="form.${column.javaField}" model="${v.base.moduleName}" enum-type="${column.enumType?substring(column.enumType?last_index_of(":") + 1)}" placeholder="请选择${column.columnLabel}" clearable/>
                            <#else>
