...
<script setup name="${v.businessNameUpper}SearchPanel" lang="ts">
    import { ref, computed } from 'vue';
    import { ElForm } from 'element-plus';
    import { ${v.businessNameUpper}Query } from '@/api/${v.businessNameLower}/${v.businessNameLower}/types';
    ...
    const queryParams = ref<${v.businessNameUpper}Query>({
        deptId: undefined,
        userId: undefined,
        orderNum: undefined,
        testKey: undefined,
...
<#list v.columns as column>
        <#--{ prop: '${column.javaField}', label: '${column.columnLabel}', htmlType: '${column.htmlType}', javaType: '${column.javaType}', query: ${column.query}, queryType: '${column.queryType}', capJavaField: '${column.capJavaField}', dictType: '${column.dictType}' },-->
