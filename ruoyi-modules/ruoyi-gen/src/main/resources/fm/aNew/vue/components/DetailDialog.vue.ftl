...
<script setup name="${v.businessNameUpper}DetailDialog" lang="ts">
    import {
        get${v.businessNameUpper},
        add${v.businessNameUpper},
        update${v.businessNameUpper}
    } from '@/api/${v.moduleName}/${v.businessNameLower}';
    ...
    const initFormData: ${v.businessNameUpper}Form = {
        <#list v.columns?filter(col -> col.insert || col.edit) as column>
